...
from .serial_off_algo import SerialOffAlgo
...
class SerialTwinSACQ(SerialOffAlgo):
    """
    Twin SAC without V, with serial collector
    """
    ...
    def __init__(
        ...
        super(SerialTwinSACQ, self).__init__(**kwargs)
        self.pf = pf
        self.qf1 = qf1
        self.qf2 = qf2
        self.target_qf1 = copy.deepcopy(qf1)
